...
public class Physician extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recycleview_physician);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        db = FirebaseFirestore.getInstance();
        usersArrayList = new ArrayList<Users>();
        myAdapter = new MyAdapter(Physician.this,usersArrayList,getApplicationContext());
        ...
        db.collection("Expert_Details").whereEqualTo("Category","Nutritionist")
